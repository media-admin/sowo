...
cookie_groups: [
	 {
		...
		cookies: [
				...
				accept: function() {
					...
					el.src = "https://www.googletagmanager.com/gtag/js?id=G-8YNH1CPQ6S";
					el.async = 1;
					...
					gtag('js', new Date());
					gtag('config', 'G-8YNH1CPQ6S', { 'anonymize_ip': true });

				},
				reject: function() {
					// Hier kommt der Opt-Out Code rein
					// Folgendes Beispiel für Google Analytics
					var disableStr = 'ga-disable-G-8YNH1CPQ6S';

					window[disableStr] = true; document.cookie = disableStr + '=true; expires=Thu, 31 Dec 2099 23:59:59 UTC; path=/';

					dywc.cookie.removeItem('_ga', '/', '.naturmachtsinn.at');
					dywc.cookie.removeItem('_gid', '/', '.naturmachtsinn.at');
					dywc.cookie.removeItem('_gat', '/', '.naturmachtsinn.at');
					dywc.cookie.removeItem('_gat_gtag_G-8YNH1CPQ6S', '/', '.naturmachtsinn.at');
				}
	},  {
